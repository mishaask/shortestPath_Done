...
int main()
{
    ...
    //this makes so isContainsCycle prints "The cycle is: 0->1->2->0". from within the method and then it will also print 1 because it returned true
    ...
    cout << Algorithms::isContainsCycle(g) << endl;    // Should print: "The cycle is:1->0->2->1".
    //this makes so isContainsCycle prints "The cycle is: 0->1->2->0". from within the method and then it will also print 1 because it returned true
    cout << Algorithms::isBipartite(g) << endl;        // Should print: "0"(false)
